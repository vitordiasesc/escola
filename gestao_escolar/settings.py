...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # Usando MariaDB como MySQL
        'NAME': 'gestao',               # O nome do banco de dados que você criou
        'USER': 'root',              # O usuário criado para acessar o banco
        'PASSWORD': 'Amv@1302',                   # A senha do usuário
